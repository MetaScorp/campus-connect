package com.campusconnect.sit.ui.fragments.common;
...
import com.campusconnect.sit.data.model.AttendanceResult;
...
import com.campusconnect.sit.ui.fragments.dialog.DatePickerFragment;
...
public class CommonViewAttendanceFragment extends BaseFragment{
    ...
    private TextView totalLect, betweenDate;

    /**
     * Instances of this class
     * @return
     */
    public static CommonViewAttendanceFragment getInstance(){
        return new CommonViewAttendanceFragment();
    }

    @Override
    protected int layoutId() {
        return R.layout.common_attendanceview;
    }
    ...
    protected void ui(View rootview) {
        ...
        betweenDate = (TextView) rootview.findViewById(R.id.betweenDate);
    }
        ...
        datePickerFragment.setCallback(new DatePickerFragment.Callback() {
            ...
            public void onDateTimeRecurrenceSet(SelectedDate selectedDate) {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        loadAttendData();
                        betweenDate.setText("Date :"+prefrences.getStartDate()+" - "+prefrences.getEndDate());
                        totalLect.setText("Lectures :"+String.valueOf(prefrences.getCounter()));
                    }
                },200);
            }
        });
    ...
    private void loadAttendData(){
        ...
        String startDate = prefrences.getStartDate();
        String endDate = prefrences.getEndDate();
        ...
        AndroidNetworking.post(Constants.VIEWATTENDANCE)
                ...
                .addBodyParameter("lect", String.valueOf(prefrences.getCounter()))
